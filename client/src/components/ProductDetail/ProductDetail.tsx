  ...
  const handleAddToCart = async () => {
    ...
    if (!AuthService.isAuthenticated()) {
      const shouldLogin = window.confirm(
        'Tenés que iniciar sesión para comprar. ¿Querés iniciar sesión ahora?'
      );
      if (shouldLogin) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        <div className="animate-pulse">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500">Redirigiendo automáticamente en unos segundos...</p>
          </div>
        </div>
      </div>
    );
          ...
          <div className="lg:w-1/2 p-8 lg:p-12">
            <div className="max-w-lg">
              ...
              <div className="mb-8">
                ...
                <p className="text-green-600 font-medium">Envío gratis en compras mayores a $50</p>
              </div>
